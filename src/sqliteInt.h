...
#endif
#if defined(SQLITE_DEBUG) && (defined(SQLITE_TEST) || defined(SQLITE_ENABLE_SELECTTRACE) || defined(SQLITE_ENABLE_TREETRACE))
...
#define FUNCTION(zName, nArg, iArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_CONSTANT | SQLITE_UTF8 | (bNC * SQLITE_FUNC_NEEDCOLL), SQLITE_INT_TO_PTR(iArg), 0, xFunc, 0, 0, 0, #zName, {0}}
#define VFUNCTION(zName, nArg, iArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_UTF8 | (bNC * SQLITE_FUNC_NEEDCOLL), SQLITE_INT_TO_PTR(iArg), 0, xFunc, 0, 0, 0, #zName, {0}}
#define SFUNCTION(zName, nArg, iArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_UTF8 | SQLITE_DIRECTONLY | SQLITE_FUNC_UNSAFE, SQLITE_INT_TO_PTR(iArg), 0, xFunc, 0, 0, 0, #zName, {0}}
#define MFUNCTION(zName, nArg, xPtr, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_CONSTANT | SQLITE_UTF8, xPtr, 0, xFunc, 0, 0, 0, #zName, {0}}
#define JFUNCTION(zName, nArg, bUseCache, bWS, bRS, bJsonB, iArg, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_DETERMINISTIC | SQLITE_FUNC_CONSTANT | SQLITE_UTF8 | ((bUseCache) * SQLITE_FUNC_RUNONLY) | ((bRS) * SQLITE_SUBTYPE) | ((bWS) * SQLITE_RESULT_SUBTYPE), SQLITE_INT_TO_PTR(iArg | ((bJsonB) * JSON_BLOB)), 0, xFunc, 0, 0, 0, #zName, {0}}
#define INLINE_FUNC(zName, nArg, iArg, mFlags) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_UTF8 | SQLITE_FUNC_INLINE | SQLITE_FUNC_CONSTANT | (mFlags), SQLITE_INT_TO_PTR(iArg), 0, noopFunc, 0, 0, 0, #zName, {0}}
#define TEST_FUNC(zName, nArg, iArg, mFlags) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_UTF8 | SQLITE_FUNC_INTERNAL | SQLITE_FUNC_TEST | SQLITE_FUNC_INLINE | SQLITE_FUNC_CONSTANT | (mFlags), SQLITE_INT_TO_PTR(iArg), 0, noopFunc, 0, 0, 0, #zName, {0}}
#define DFUNCTION(zName, nArg, iArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_SLOCHNG | SQLITE_UTF8, 0, 0, xFunc, 0, 0, 0, #zName, {0}}
#define PURE_DATE(zName, nArg, iArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_SLOCHNG | SQLITE_UTF8 | SQLITE_FUNC_CONSTANT, (void *)&sqlite3Config, 0, xFunc, 0, 0, 0, #zName, {0}}
#define FUNCTION2(zName, nArg, iArg, bNC, xFunc, extraFlags) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_CONSTANT | SQLITE_UTF8 | (bNC * SQLITE_FUNC_NEEDCOLL) | extraFlags, SQLITE_INT_TO_PTR(iArg), 0, xFunc, 0, 0, 0, #zName, {0}}
#define STR_FUNCTION(zName, nArg, pArg, bNC, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_SLOCHNG | SQLITE_UTF8 | (bNC * SQLITE_FUNC_NEEDCOLL), pArg, 0, xFunc, 0, 0, 0, #zName, {0}}
#define LIKEFUNC(zName, nArg, arg, flags) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_CONSTANT | SQLITE_UTF8 | flags, (void *)arg, 0, likeFunc, 0, 0, 0, #zName, {0}}
#define WAGGREGATE(zName, nArg, arg, nc, xStep, xFinal, xValue, xInverse, f) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_UTF8 | (nc * SQLITE_FUNC_NEEDCOLL) | f, SQLITE_INT_TO_PTR(arg), 0, xStep, xFinal, xValue, xInverse, #zName, {0}}
#define INTERNAL_FUNCTION(zName, nArg, xFunc) \
    {nArg, SQLITE_FUNC_BUILTIN | SQLITE_FUNC_INTERNAL | SQLITE_UTF8 | SQLITE_FUNC_CONSTANT, 0, 0, xFunc, 0, 0, 0, #zName, {0}}
...
struct Parse
{
    ...
    **************************************************************************/
    ...
    union
    {
        ...
        struct
        {                          /* These fields available to all other statements */
...
#if defined(VDBE_PROFILE) || defined(SQLITE_PERFORMANCE_TRACE) || defined(SQLITE_ENABLE_STMT_SCANSTATUS)
